...
namespace task01_41 // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static string descriptionApp =
@"************************************************
* Программа производит подсчет кол-ва          *
* введнных пользователем положительных чисел   *
************************************************";
        static bool CheckInsert(bool[] check)
        {
        ...
        static int CalcPosNumbers(double[] numbers)
        {
            int result = 0;
